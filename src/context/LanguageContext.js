...
export const translations = {
  en: {
    ...
    // Report and export translations
    ...
    availabilityActivities: 'Availability Activities',
    taskActivities: 'Task Activities',
    locationActivities: 'Location Activities',
    ...
    taskAcceptedMessage: 'You have accepted this task. The timer has started.',
    taskRejected: 'Task Rejected',
    taskRejectedMessage: 'You have rejected this task. It will be removed from your list.',
    acceptTaskQuestion: 'Do you want to accept this task?',
    timeLimitInfo: 'Time Limit',
    minutes: 'minutes',
    accept: 'Accept',
    reject: 'Reject',
    errorRespondingToTask: 'There was an error responding to the task. Please try again.',
    taskAlreadyResponded: 'This task has already been accepted or rejected.',
  ...
  es: {
    ...
    availabilityActivities: 'Actividades de Disponibilidad',
    taskActivities: 'Actividades de Tareas',
    locationActivities: 'Actividades de Ubicación',
    groupByUser: 'Agrupar por Usuario',
    listView: 'Vista de Lista',
    
    // View modes
    viewMode: 'Modo de Vista',
    listMode: 'Lista',
    groupedMode: 'Por Usuario',
    ...
    deleteConfirmation: '¿Estás seguro que deseas eliminar este usuario? Esta acción no se puede deshacer.',
    cancel: 'Cancelar',
    delete: 'Eliminar',
    ...
    enterActivity: 'Ingresa tu actividad (ej. "Vaciado de tanque", "Reparación de válvula")',
    ...
    errorDeletingLocation: 'Error al eliminar la ubicación. Por favor, inténtalo de nuevo.',
    errorSavingLocationToBackend: 'Error al guardar la ubicación en el servidor. Por favor, verifica tu conexión.',
    saveLocationPrompt: 'Por favor, ingresa un nombre para esta ubicación',
    ...
    loadingSavedLocations: 'Cargando ubicaciones guardadas...',
    noSavedLocations: 'No hay ubicaciones guardadas',
    saveLocationHint: 'Añade primero una ubicación para verla aquí',
    assignedRadius: 'Radio Asignado:',
    coordinates: 'Coordenadas:',
    handsFreeMode: 'Modo manos libres',
    voiceKeywords: 'Palabras clave de voz',
    keywordPlaceholder: 'Ingrese palabra clave y presione +',
    ...
    taskAcceptedMessage: 'Has aceptado esta tarea. El temporizador ha comenzado.',
    taskRejected: 'Tarea Rechazada',
    taskRejectedMessage: 'Has rechazado esta tarea. Será eliminada de tu lista.',
    acceptTaskQuestion: '¿Quieres aceptar esta tarea?',
    timeLimitInfo: 'Tiempo Límite',
    minutes: 'minutos',
    accept: 'Aceptar',
    reject: 'Rechazar',
    errorRespondingToTask: 'Hubo un error al responder a la tarea. Por favor, inténtalo de nuevo.',
    taskAlreadyResponded: 'Esta tarea ya ha sido aceptada o rechazada.',
